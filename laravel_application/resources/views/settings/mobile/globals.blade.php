        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group row col-12">
                    ...
                    <div class="col-10">
                        {!! Form::text('google_maps_key', config('installer.demo_app', false) ? "AIzaSyAT07iMlfZ9bJt1gmGj9KhJDLFY8srI6dA" : setting('google_maps_key',"YOUR-GOOGLE-MAPS-KEY-HERE"),  ['class' => 'form-control','placeholder'=>  trans('lang.app_setting_google_maps_key_placeholder')]) !!}
